...
export class AddReferralBoostToWallet1731230311549 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "wallets" ADD "referralBoost" numeric(18,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "wallets" ALTER COLUMN "lendingUSDCPoints" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "wallets" ALTER COLUMN "lendingUSDCPoints" SET DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "wallets" ALTER COLUMN "borrowingUSDCPoints" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "wallets" ALTER COLUMN "borrowingUSDCPoints" SET DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "wallets" ALTER COLUMN "totalEarnedPoints" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "wallets" ALTER COLUMN "totalEarnedPoints" SET DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "wallets" ALTER COLUMN "borrowingUSDCPoints" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "wallets" ALTER COLUMN "borrowingUSDCPoints" DROP NOT NULL`);
