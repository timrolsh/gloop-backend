...
export class WalletController {
    ...
    async getUserDashboard(@GetWalletFactory() walletId: string): Promise<ResultDto<DashboardResponseDto>> {
    ...
    async getLeaderboardList(@Query() leaderboardListRequestDto: LeaderboardListRequestDto): Promise<ResultDto<{ LeaderboardList: LeaderboardListResponseDto[]; totalUsers: number }>> {
