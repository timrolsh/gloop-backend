import { Controller, Post, Body, UnauthorizedException, Get, UseGuards, Headers, HttpStatus } from "@nestjs/common";
...
export class AuthController {
    ...
    async refreshTokenUser(@Headers("authorization") authorization: string): Promise<ResultDto<AuthResponseDto>> {
        if (!authorization) {
            throwCustomHttpException("Authorization header missing", "sdfsdfsdf", HttpStatus.UNAUTHORIZED);
        }
