export const configuration = () => ({
  ...
  crypto: {
    ...
    rpcUrl:
      process.env.NETWORK === "testnet" ? process.env.TESTNET_RPC_URL : process.env.MAINNET_RPC_URL,
    rpcSocket:
      process.env.NETWORK === "testnet"
        ? process.env.TESTNET_RPC_SOCKET
        : process.env.MAINNET_RPC_SOCKET,
    gmPointContactAddress:
      process.env.NETWORK === "testnet"
        ? process.env.GM_POINTS_CONTACT_ADDRESS_TESTNET
        : process.env.GM_POINTS_CONTACT_ADDRESS_MAINNET,
    gmBtc:
      process.env.NETWORK === "testnet" ? process.env.GM_BTC_TESTNET : process.env.GM_BTC_MAINNET,
    gmETH:
